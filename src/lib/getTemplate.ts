...
<head>
    ...
    <style type="text/css">
        .vertical-line-cell {
            background-image: url('https://ik.imagekit.io/ixtx5enruw/line.png?updatedAt=1754730928045');
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" class="left-content">
                                            ...
                                            <p
                                                ...
                                                <strong>Note:</strong>If you wish to cancel your booking, please inform us immediately at <a href="mailto:commscope@msdplus.com">commscope@msdplus.com</a>.</p>
                                            <p
                                                style="color: #333333; font-family: Arial, Helvetica, sans-serif; font-size: 16.693px; line-height: 1.5;">
                                                The event will take place at <a href="https://www.peninsula.com/en/bangkok/5-star-luxury-hotel-riverside">The Peninsula, Bangkok</a>, from <strong>29th September to 2nd October 2025.</strong></p>
                                            <p
                                                style="color: #333333; font-family: Arial, Helvetica, sans-serif; font-size: 16.693px; line-height: 1.5;">
                                             ...
                                             <a href="https://commscope.msdplus.com/invite/Save_the_Date-CommScope_Technology_Forum_2025.ics">Save_the_Date-CommScope_Technology_Forum_2025</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
